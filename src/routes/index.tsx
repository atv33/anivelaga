      ...
      >
        {detailsHref ? (
          <ProjectDetailsCta
            ...
            compact
            noPulse={p.slug === "serial-test-board"}
          />
        ) : null}
